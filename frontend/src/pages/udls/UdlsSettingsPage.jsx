...
//    // ── LOAD USER SETTINGS ─────────────────────────────
//   useEffect(() => {
//     if (user?.staff_id || localStorage.getItem("staff_id")) {
//       fetchSettings();
//     }
//   }, [user]);
...
//     const storedStaffId = localStorage.getItem("staff_id") || user?.staff_id;
...
//     const res = await fetch(`${BASE_URL}/udls/settings/?staff_id=${storedStaffId}`);
...
//     const res = await fetch(`${BASE_URL}/udls/settings/`, {
//       method: "PUT",
//       headers: {
//         "Content-Type": "application/json",
//       },
//       body: JSON.stringify({
//         staff_id,   // 👈 ALWAYS explicitly send this
//         username: fullName,
//         email,
...
function UdlsSettingsPage({ embedded }) {
  ...
  // ── LOAD SETTINGS ─────────────────────────────
  useEffect(() => {
  const staff_id = user?.staff_id || localStorage.getItem("staff_id");
  ...
  try {
    ...
    const staff_id =
      user?.staff_id || localStorage.getItem("staff_id");
    ...
    const res = await fetch(
      `${BASE_URL}/udls/settings/?staff_id=${staff_id}`
    );
    ...
    setEmail(data.email || "");
    setStaffId(data.staff_id || staff_id);
  ...
  const content = (
    <div style={pageWrapper}>
      ...
      <div style={card}>
        <div style={cardHeader}>
          <span style={cardTitle}>Account Information</span>
        </div>
