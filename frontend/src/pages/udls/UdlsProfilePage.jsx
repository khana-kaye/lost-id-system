...
//             </div>
//             <button style={backBtn} onClick={() => navigate("/udls/dashboard")}>
//               ← Back
//             </button>
//           </div>
//         </div>
...
const staff = {
username: "Sarah Namusoke",
staffId: "UDLS-234",
email: "[s.namusoke@udls.go.ug](mailto:s.namusoke@udls.go.ug)",
staffRole: "Permit Verification Officer",
status: "Active",
lastLogin: "04 June 2026, 09:15 AM",
...
return ( <PageLayout> <div style={pageWrapper}> <div style={header}> <div> <h1 style={title}>🪪 Staff Profile</h1> <p style={subtitle}>
Your UDLS account information and identity details. </p> </div>


      <button
        style={backBtn}
        onClick={() => navigate("/udls/dashboard")}
      >
        ← Back
      </button>
    </div>
...
function InfoRow({ label, value }) {
return ( <div style={infoRow}> <div style={infoLabel}>{label}</div> <div style={infoValue}>{value}</div> </div>
);
}
